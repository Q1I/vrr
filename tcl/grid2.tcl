...
# Scenario parameters
#------------------------------------------------------------------
set val(x)              25   ;# X dimension of the topography
set val(y)              25   ;# Y dimension of the topography
set val(ifqlen)         100    ;# max packet in queue
set val(seed)           0.0    ;#random seed            
set val(adhocRouting)   VRR
set val(nn)             6  ;# how many nodes are simulated
...
set tracefd	[open grid-out.tr w]
$ns_ use-newtrace  ;# use the new wireless trace file format
set namtrace    [open grid-out.nam w]
...
puts $tracefd "M 0.0 sc cp seed $val(seed)"
